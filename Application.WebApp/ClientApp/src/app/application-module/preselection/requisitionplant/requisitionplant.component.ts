...
export class RequisitionplantComponent implements OnInit {  
  ...
  getAllDepartment() {
    this.departments = [];
    this.searchDepartment.verticalId = 2;
  ...
  getAllPosition() {
    this.positions = [];
    this.searchPosition.verticalId = 2;
  ...
  getAllJobDescription() {
    ...
    this.searchJobDescription.verticalId = 2;
